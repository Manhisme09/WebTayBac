    ...
    <div style="width:50%;">
        <?php foreach ($data['inforCustomer'] as $each) : ?>
            <form class="infor_form" action="" method="post">
                ...
                <input id="inp" type="text" name="name_receiver" value="<?php echo $each['first_name'] . " " . $each['last_name'] ?>" placeholder="Họ và tên">
                <br>
                <label for="">Số điện thoại</label>
                <input id="inp" type="text" name="phone_receiver" value="<?php echo $each['phone_number'] ?>" placeholder="Số điện thoại">
                <br>
                <label for="">Địa chỉ</label>
                <input id="inp" type="text" name="address_receiver" value="<?php echo $each['address'] ?>" placeholder="Địa chỉ">
                <br>
